...
| Arena | Auto-attacks, manually activated skills/consumables and timed critical enhancement. Review. Original has 30+ encounters and survival per developer listings. | 20 active encounters in two stages of ten, with Stage 3 marked Coming soon, 3 waves each, with fixed encounter stat targets, stage bosses and the existing enemy roster. First clears pay an exact tenfold currency sequence; repeats pay 15% of their own base reward before Lodge bonuses. Survival opens after encounter 20; legacy completed-12 saves retain their prior unlock. |
...
| Equipment | Purchasable gear enhances the hero. Listings. | Weapon, armor and shield slots with 20 available upgrade ranks. Stable original IDs and separate rendering descriptors; later +N ranks reuse existing appearances. Matching-set and individual next-tier purchases. |
