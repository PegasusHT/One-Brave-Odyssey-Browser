const CACHE_NAME='obo-game-2026-09-15-2';
const FILES=['./','index.html','style.css','game.js','core.js','art.js','portrait-art.js','action-art.js','training.js','battle.js','strength-layout.js','strength-art.js','dodge-art.js','block-art.js','critical-art.js','mobile.js','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png','icons/apple-touch-icon.png','assets/hero-idle/idle.png','assets/hero-idle/wayfarer-upgrade-iii.png','assets/hero-actions/jump-land.png','assets/hero-actions/attack.png'];
